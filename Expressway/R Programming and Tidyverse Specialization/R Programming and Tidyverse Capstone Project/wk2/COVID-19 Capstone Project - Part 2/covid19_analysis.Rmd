...
us_counties_20to22 %>%
  ...
  scale_color_manual(name = "Covid-19", values= c("cases" = "blue", "deaths" = "red")
  ) + 
  scale_y_continuous(
    name = NULL,
    trans = "log10",
  ...
  ggtitle("Total covid-19 cases and deaths in us")
...
totals <- us_counties_20to22 %>%
  ...
  mutate(`delta_deaths_1` = `total deaths` - lag(`total deaths`),
         `delta_cases_7` = `total cases` - lag(x = `total cases`, n = 1, order_by=date),
