...
url = "https://en.wikipedia.org/wiki/Gymnastics_at_the_2012_Summer_Olympics_%E2%80%93_Men%27s_floor"
...
if len(tables) >= 2:
    ...
    csv_filename = 'Gymnastics_ 2012_Olympics_Men\'s_artistic_floor.csv'
