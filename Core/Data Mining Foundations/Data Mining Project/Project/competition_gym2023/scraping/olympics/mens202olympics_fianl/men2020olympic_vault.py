...
url = "https://en.wikipedia.org/wiki/Gymnastics_at_the_2020_Summer_Olympics_%E2%80%93_Men%27s_vault"
...
if len(tables) >= 3:
    ...
    csv_filename = 'Gymnastics_ 2020_Olympics_Men\'s_artistic_vault.csv'
