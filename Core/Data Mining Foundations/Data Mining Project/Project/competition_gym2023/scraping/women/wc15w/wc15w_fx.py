...
url = "https://en.wikipedia.org/wiki/2015_World_Artistic_Gymnastics_Championships"
...
if len(tables) >= 34:
    ...
    df.to_csv('wc15w_fx.csv', index=False, header=False)

    print("Table 21 data has been scraped and saved as wc15w_fx.csv.")
else:
