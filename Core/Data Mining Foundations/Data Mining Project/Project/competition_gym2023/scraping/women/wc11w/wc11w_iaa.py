...
url = "https://en.wikipedia.org/wiki/2011_World_Artistic_Gymnastics_Championships"
...
if len(tables) >= 11:
    ...
    df.to_csv('wc11w_iaa.csv', index=False, header=False)

    print("Table 21 data has been scraped and saved as wc11w_iaa.csv.")
else:
