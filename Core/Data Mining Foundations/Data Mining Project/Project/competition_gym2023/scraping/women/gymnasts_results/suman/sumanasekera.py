...
# URL of the page
url = "https://thegymter.net/tiana-sumanasekera/"

# Scrape and save the second table as "jones23.csv"
scrape_and_save_table(url, 2, "suman23.csv")

# Scrape and save the third table as "jones22.csv"
scrape_and_save_table(url, 3, "suman22.csv")

# Scrape and save the fourth table as "jones21.csv"
scrape_and_save_table(url, 4, "suman21.csv")
