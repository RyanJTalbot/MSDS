...
url = "https://en.wikipedia.org/wiki/2020_European_Women%27s_Artistic_Gymnastics_Championships"
...
if response.status_code == 200:
    ...
    if len(tables) >= 14:
        ...
        with open("euro2020bb.csv", mode="w", newline="", encoding="utf-8") as csv_file:
        ...
        print("Table data has been saved to euro2020bb.csv.")
    else:
