...
if response.status_code == 200:
    ...
    if len(tables) >= 2:
        ...
        # Save the data to a CSV file named "best_vault2023.csv"
        with open("best_vault2023.csv", mode='w', newline='') as file:
        ...
        print("Data saved to best_vault2023.csv successfully.")
    else:
