...
if response.status_code == 200:
    ...
    # Find the fourth table on the page
    tables = soup.find_all('table')

    if len(tables) >= 4:
        table = tables[3]  # Use the fourth table
        ...
        # Save the data to a CSV file named "best_UB2023.csv"
        with open("best_UB2023.csv", mode='w', newline='') as file:
        ...
        print("Data saved to best_UB2023.csv successfully.")
    else:
        print("No fourth table found on the page.")
else:
