...
url = 'https://thegymter.net/2022/08/23/2022-south-american-championships-results/'
...
df.to_csv(
    '/Users/ryantalbot/Desktop/MSDS/south_america22championship_iaa.csv', index=False)
