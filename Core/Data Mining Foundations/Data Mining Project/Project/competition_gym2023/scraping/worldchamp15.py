...
url = "https://en.wikipedia.org/wiki/2015_World_Artistic_Gymnastics_Championships#Team_competition_2"
...
if len(tables) >= 23:
    ...
    csv_filename = 'Women2015World_Artistic_Gymnastics_Championships.csv'
