...
# URL of the page
url = "https://thegymter.net/jade-carey/"

# Scrape and save the second table as "jones23.csv"
scrape_and_save_table(url, 2, "carey23.csv")

# Scrape and save the third table as "jones22.csv"
scrape_and_save_table(url, 3, "carey22.csv")

# Scrape and save the fourth table as "jones21.csv"
scrape_and_save_table(url, 4, "carey21.csv")
