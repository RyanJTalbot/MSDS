...
url = "https://en.wikipedia.org/wiki/2017_World_Artistic_Gymnastics_Championships"
...
if len(tables) >= 22:
    ...
    df.to_csv('wc17w_iaa.csv', index=False, header=False)

    print("Table 21 data has been scraped and saved as wc17w_iaa.csv.")
else:
