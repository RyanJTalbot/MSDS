...
if response.status_code == 200:
    ...
    # Find the sixth table on the page
    tables = soup.find_all('table')

    if len(tables) >= 6:
        table = tables[5]  # Use the sixth table
        ...
        # Save the data to a CSV file named "best_floor2023.csv"
        with open("best_floor2023.csv", mode='w', newline='') as file:
        ...
        print("Data saved to best_floor2023.csv successfully.")
    else:
        print("No sixth table found on the page.")
else:
